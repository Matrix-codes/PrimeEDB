...
class WirelessPage {
      ...
      <div class="page-enter">
        ...
        <div class="card" style="margin-bottom:var(--space-5);">
          ...
          <p class="text-muted" style="font-size:0.85rem; margin-bottom:var(--space-4);">
            First connect your device via USB, then enable TCP/IP mode. After this step, you can disconnect the USB cable.
          </p>
        ...
        <div class="card" style="margin-bottom:var(--space-5);">
          <div class="section-header">
            <span class="section-title">🌐 Step 2: Connect via IP</span>
          </div>
          <div class="grid-2" style="gap:var(--space-4);">
            <div>
              <div class="form-field">
                <label class="form-label">IP Address</label>
                <input type="text" id="wireless-ip" placeholder="192.168.1.100" />
              </div>
              <div class="form-field">
              ...
              <div class="flex items-center gap-2" style="margin-bottom:var(--space-3);">
                <label class="toggle-label">
                  <div class="toggle"><input type="checkbox" id="wireless-save-device"><div class="toggle-track"></div><div class="toggle-thumb"></div></div>
                  <span class="text-sm">Save this device</span>
                </label>
              </div>
              <div class="btn-group">
                <button class="btn btn-primary" id="wireless-connect-btn">🔗 Connect</button>
                <button class="btn btn-secondary" id="wireless-disconnect-btn">✕ Disconnect</button>
              </div>
            </div>
            <div class="output-box" id="wireless-connect-output" style="min-height:120px; align-self:start;">Connection output will appear here.</div>
          </div>
        </div>
  ...
  _bindEvents(container) {
    ...
    container.querySelector('#wireless-disconnect-btn')?.addEventListener('click', () => this._disconnect());
